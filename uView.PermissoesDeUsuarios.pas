unit uView.PermissoesDeUsuarios;
...
type
  TFrmPermissoesDeUsuarios = class(TForm1)
    Panel7: TPanel;
    Label1: TLabel;
...
function FrmPermissoesDeUsuarios: TFrmPermissoesDeUsuarios;
...
procedure TFrmPermissoesDeUsuarios.AtivarPermissaoPorComponente
...
procedure TFrmPermissoesDeUsuarios.AtivarPermissoesFixas(const PerfilID: Integer);
var
  NomeTela: string;
  NomeAcao: String;
...
procedure TFrmPermissoesDeUsuarios.btnEditarUsuarioClick(Sender: TObject);
begin
  inherited;
  DM.qryUsuarios.Edit;
end;

procedure TFrmPermissoesDeUsuarios.btnExcluirUsuarioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmPermissoesDeUsuarios.ListarUsuarios;
begin
  DM.ListarUsuarios(edtPesquisarUsuario.Text, cbPerfilUsuario.KeyValue);
end;

procedure TFrmPermissoesDeUsuarios.btnNovoUsuarioClick(Sender: TObject);
begin
  inherited;
  edtNomeUsuario.Text := '';
...
procedure TFrmPermissoesDeUsuarios.btnSalvarUsuarioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmPermissoesDeUsuarios.btnFecharClick(Sender: TObject);
begin
  inherited;
  Self.Close;
end;
...
function FrmPermissoesDeUsuarios: TFrmPermissoesDeUsuarios;
begin
  Result := TFrmPermissoesDeUsuarios(TFrmPermissoesDeUsuarios.GetInstance);
end;

procedure TFrmPermissoesDeUsuarios.CarregarItensMenu;
var
  i, j: Integer;
begin
...
procedure TFrmPermissoesDeUsuarios.cbPerfilCloseUp(Sender: TObject);
begin
...
procedure TFrmPermissoesDeUsuarios.ExportD2Bridge;
begin
  inherited;
...
procedure TFrmPermissoesDeUsuarios.FormClose(Sender: TObject;
...
procedure TFrmPermissoesDeUsuarios.FormShow(Sender: TObject);
begin
...
procedure TFrmPermissoesDeUsuarios.InitControlsD2Bridge(const PrismControl
  : TPrismControl);
begin
  inherited;
...
procedure TFrmPermissoesDeUsuarios.ReexportarAbaPermissoes;
begin
...
procedure TFrmPermissoesDeUsuarios.RenderD2Bridge(const PrismControl
