...
type
  TFrmBuscaDeUsuarios = class(TForm1)
...
function FrmBuscaDeUsuarios: TFrmBuscaDeUsuarios;
...
procedure TFrmBuscaDeUsuarios.AtivarPermissaoPorComponente
...
procedure TFrmBuscaDeUsuarios.AtivarPermissoesFixas(const PerfilID: Integer);
var
  NomeTela: string;
  NomeAcao: String;
...
procedure TFrmBuscaDeUsuarios.btnEditarUsuarioClick(Sender: TObject);
begin
  inherited;
  DM.qryUsuarios.Edit;
end;

procedure TFrmBuscaDeUsuarios.btnExcluirUsuarioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmBuscaDeUsuarios.ListarUsuarios;
begin
  DM.ListarUsuarios(edtPesquisarUsuario.Text, cbPerfilUsuario.KeyValue);
end;

procedure TFrmBuscaDeUsuarios.btnNovoUsuarioClick(Sender: TObject);
begin
  inherited;
  edtNomeUsuario.Text := '';
...
procedure TFrmBuscaDeUsuarios.btnSalvarUsuarioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmBuscaDeUsuarios.btnFecharClick(Sender: TObject);
begin
  inherited;
  Self.Close;
end;
...
function FrmBuscaDeUsuarios: TFrmBuscaDeUsuarios;
begin
  Result := TFrmBuscaDeUsuarios(TFrmBuscaDeUsuarios.GetInstance);
end;

procedure TFrmBuscaDeUsuarios.CarregarItensMenu;
var
  i, j: Integer;
begin
...
procedure TFrmBuscaDeUsuarios.cbPerfilCloseUp(Sender: TObject);
begin
...
procedure TFrmBuscaDeUsuarios.ExportD2Bridge;
begin
  inherited;
...
procedure TFrmBuscaDeUsuarios.FormClose(Sender: TObject;
...
procedure TFrmBuscaDeUsuarios.FormShow(Sender: TObject);
begin
...
procedure TFrmBuscaDeUsuarios.InitControlsD2Bridge(const PrismControl
  : TPrismControl);
begin
  inherited;
...
procedure TFrmBuscaDeUsuarios.ReexportarAbaPermissoes;
begin
...
procedure TFrmBuscaDeUsuarios.RenderD2Bridge(const PrismControl
