...
type
  TFrmPefilDeUsuarios = class(TForm1)
...
function FrmPefilDeUsuarios: TFrmPefilDeUsuarios;
...
procedure TFrmPefilDeUsuarios.AtivarPermissaoPorComponente
...
procedure TFrmPefilDeUsuarios.AtivarPermissoesFixas(const PerfilID: Integer);
var
  NomeTela: string;
  NomeAcao: String;
...
procedure TFrmPefilDeUsuarios.btnEditarUsuarioClick(Sender: TObject);
begin
  inherited;
  DM.qryUsuarios.Edit;
end;

procedure TFrmPefilDeUsuarios.btnExcluirUsuarioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmPefilDeUsuarios.ListarUsuarios;
begin
  DM.ListarUsuarios(edtPesquisarUsuario.Text, cbPerfilUsuario.KeyValue);
end;

procedure TFrmPefilDeUsuarios.btnNovoUsuarioClick(Sender: TObject);
begin
  inherited;
  edtNomeUsuario.Text := '';
...
procedure TFrmPefilDeUsuarios.btnSalvarUsuarioClick(Sender: TObject);
begin
  inherited;
...
procedure TFrmPefilDeUsuarios.btnFecharClick(Sender: TObject);
begin
  inherited;
  Self.Close;
end;
...
function FrmPefilDeUsuarios: TFrmPefilDeUsuarios;
begin
  Result := TFrmPefilDeUsuarios(TFrmPefilDeUsuarios.GetInstance);
end;

procedure TFrmPefilDeUsuarios.CarregarItensMenu;
var
  i, j: Integer;
begin
...
procedure TFrmPefilDeUsuarios.cbPerfilCloseUp(Sender: TObject);
begin
...
procedure TFrmPefilDeUsuarios.ExportD2Bridge;
begin
  inherited;
...
procedure TFrmPefilDeUsuarios.FormClose(Sender: TObject;
...
procedure TFrmPefilDeUsuarios.FormShow(Sender: TObject);
begin
...
procedure TFrmPefilDeUsuarios.InitControlsD2Bridge(const PrismControl
  : TPrismControl);
begin
  inherited;
...
procedure TFrmPefilDeUsuarios.ReexportarAbaPermissoes;
begin
...
procedure TFrmPefilDeUsuarios.RenderD2Bridge(const PrismControl
